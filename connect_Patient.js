function sendMessage(chattext) {
    /*alert('Message sent');*/
var translatedtext =document.getElementById("9_CHATVALUE").value;
var translatedtext =document.getElementById("9_CHATVALUE").value;
document.getElementById("9_CHATVALUE").value="";
...
/*alert(chattext);*/
 var jwttoken =  document.getElementById('9_JWT').value;
...
myHeaders.append("accept-language", "en-US,en;q=0.9");
 ...
 var postchaturl =     "https://spacesapis.avayacloud.com/api/spaces/"+ document.getElementById('9_SPACESID').value+"/chats"    ;
/*alert('Post Messages '+document.getElementById('9_SPACESID').value); */
...
myHeaders.append("accept-language", "en-US,en;q=0.9");
var spacesurl =    "https://spacesapis.avayacloud.com/api/spaces/"+document.getElementById('9_SPACESID').value+"/messages/query?refTime=&direction=after";
/*alert('Get messages '+document.getElementById('9_SPACESID').value); */
var requestOptions = {
  method: 'GET',
  headers: myHeaders,
  redirect: 'follow'
...
var spacename =document.getElementById("9_NEWSPACE").value;
document.getElementById("NEWSPACE").value="";
var inviteemail =document.getElementById("9_INVITEE").value;
document.getElementById("9_INVITEE").value="";
var jwttoken =  document.getElementById('9_JWT').value;
var myHeaders = new Headers();
myHeaders.append("authority", "spacesapis.avayacloud.com");
myHeaders.append("accept", "application/json");
...
myHeaders.append("referer", "https://spaces.avayacloud.com/spaces/5f0c736c1e182a13e22d1295");
myHeaders.append("accept-language", "en-US,en;q=0.9");
var memspacesurl =    "https://spacesapis.avayacloud.com/api/spaces/"+document.getElementById('9_SPACESID').value+"/members";

/*alert('Members '+document.getElementById('9_SPACESID').value); */
...
myHeaders.append("referer", "https://spaces.avayacloud.com/spaces/5f0c736c1e182a13e22d1295");
myHeaders.append("accept-language", "en-US,en;q=0.9");
var getspacesurl =    "https://spacesapis.avayacloud.com/api/spaces/"+document.getElementById('9_SPACESID').value;
var requestOptions = {
  method: 'GET',
  headers: myHeaders,
  redirect: 'follow'
 ...
 function googleTranslate()
  {
	 ...
	 var text =document.getElementById("9_CHATVALUE").value;
...
function setSpace(spacevalue)  {
  ...
  if (spacevalue != null) {
  /*alert("inside");*/
    document.getElementById('spaceval').innerHTML =spacevalue;
    alert("spacevalue "+document.getElementById('spaceval').innerHTML);
  }
}
